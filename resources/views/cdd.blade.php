                                       ...
                                       <a href="{{ route('NewEmploye') }}"><button class="btn btn-success float-right">Ajouter</button></a>
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                @foreach($data as $cdd)
                                                <tr>
                                                    <th scope="row">{{ $cdd->id }}</th>
                                                    <td class="nom">{{ $cdd->nom }}</td>
                                                    <td class="nom">{{ $cdd->prenom }}</td>
                                                    <td class="nom">{{ $cdd->sexe  }}</td>
                                                    <td class="nom">{{ $cdd->poste  }}</td>
                                                    <td class="nom">{{ $cdd->date_de_recrutement  }}</td>
                                                    <td class="nom">{{ $cdd->status  }}</td>
                                                    <td class="nom">{{ $cdd->matricule  }}</td>
                                                    <td class="text-center" style="display: grid;">
                                                    <a href="{{ url('details/'.$cdd->id) }}" >                                

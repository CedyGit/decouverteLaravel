                                       ...
                                       <a href="{{ route('NewEmploye') }}"><button class="btn btn-success float-right">Ajouter</button></a>
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                @foreach($data as $cdi)
                                                <tr>
                                                    <th scope="row">{{ $cdi->id}}</th>
                                                    <td class="nom">{{ $cdi->nom }}</td>
                                                    <td class="nom">{{ $cdi->prenom }}</td>
                                                    <td class="nom">{{ $cdi->sexe  }}</td>
                                                    <td class="nom">{{ $cdi->poste  }}</td>
                                                    <td class="nom">{{ $cdi->date_de_recrutement  }}</td>
                                                    <td class="nom">{{ $cdi->status  }}</td>
                                                    <td class="nom">{{ $cdi->matricule  }}</td>
                                                    <td class="text-center" style="display: contents;">
                                                        <a href="{{ url('details/'.$cdi->id ) }}">
                                                            <button class="btn btn-info btn-outline-info" title="Details">
                                                                <em class="icofont icofont-info-square"></em>
                                                            </button>
                                                        </a>
                                                        <a href="{{ url('congeForm/'.$cdi->id) }}">
                                                            <button class="btn btn-success btn-outline-success" title="ajouter un Congé">

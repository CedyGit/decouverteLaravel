                ...
                <!-- fin sidebar -->
                    <div class="pcoded-content">
                        <div class="pcoded-inner-content">
                            <div class="main-body">
                                <h3 class="text-center">Creation d'une demande de congé</h3>
                                ...
                                <div>
                                            <form action="{{ route('register-conge') }}" method="post" enctype="multipart/form-data">
                                            @csrf
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="cal-icon">
                                                                <input type="text" class="form-control" name="demandeur" value="{{ $employe->prenom }}" readonly>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="cal-icon">
                                                                <input type="text" class="form-control" name="poste_occuper" value="{{ $employe->poste }}" readonly>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="cal-icon">
                                                                <input class="datepicker-default form-control" type="date" name="date_de_debut">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="cal-icon">
                                                                <input class="datepicker-default form-control" type="date" name="date_de_fin">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="cal-icon">
                                                                <input type="number" class="form-control" id="nombre_de_jours" name="nombre_de_jours">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" name="motifs" id="" cols="30" rows="5"></textarea>
                                                        </div>
                                                    </div>

                                                    <!-- input employe_id hidden -->
                                                        <input class="form-control" type="hidden" id="employe_id" name="employe_id" value="{{ $employe->id }}">

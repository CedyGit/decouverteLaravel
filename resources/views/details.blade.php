                                ...
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-body">
                                        ...
                                        <div class="container">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="card" style="background-color: #319acdcc;">
                                                    @foreach ($employe as $details)
                                                        <!-- header -->
                                                        <div class="card-header">
                                                            <div class="row">
                                                                ...
                                                                <!-- photo -->
                                                                    <div class="profile-img-wrap">
                                                                        <div class="profile-img">
                                                                            <a href="{{ url('editEmploye/'.$details->id) }}" title="Mofifier?">
                                                                                <img src="../uploads/{{ $details->avatar }}" alt="">
                                                                            </a>
                                                                        </div>
                                                                    </div>
                                                                <!-- fin photo -->
                                                                ...
                                                                <div class="col-md-8">
                                                                    <h3 class="text-center" style="color:ghostwhite ;">Details de {{ $details->nom }} {{ $details->prenom }}</h3>
                                                                    <hr> 
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="card-body">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-4">
                                                                        <label for="">ID</label>
                                                                        <div class="p-2 border">{{ $details->id }}</div>
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <label for="">NOM</label>
                                                                        <div class="p-2 border">{{ $details->nom }}</div>
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <label for="">Prénom</label>
                                                                        <div class="p-2 border">{{ $details->prenom }}</div>
                                                                    </div> 
                                                                    <div class="col-md-4">
                                                                        <label for="">Email</label>
                                                                        <div class="p-2 border">{{ $details->email }}</div>
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <label for="">Date de Naissance</label>
                                                                        <div class="p-2 border">{{ $details->date_de_naissance }}</div>
                                                                    </div>

                                                                    <!--  -->
                                                                    <div class="col-md-4">
                                                                        <label for="">SEXE</label>
                                                                        <div class="p-2 border">{{ $details->sexe }}</div>
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <label for="">Numéro</label>
                                                                        <div class="p-2 border">{{ $details->numero }}</div>
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <label for="">poste</label>
                                                                        <div class="p-2 border">{{ $details->poste }}</div>
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <label for="">Date de recrutement</label>
                                                                        <div class="p-2 border">{{ $details->date_de_recrutement }}</div>
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <label for="">Status</label>
                                                                        <div class="p-2 border">{{ $details->status }}</div>
                                                                    </div>

                                                                    <div class="col-md-4">
                                                                        <label for="">Matricule</label>
                                                                        <div class="p-2 border">{{ $details->matricule }}</div>
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <label for="">Adresse</label>
                                                                        <div class="p-2 border">{{ $details->adress }}</div>
                                                                    </div>

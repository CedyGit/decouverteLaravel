                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control" type="text" id="nom" name="nom" placeholder="Nom" value="{{ $employe->nom }}">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control" type="text" id="prenom" name="prenom" placeholder="Prenom" value="{{ $employe->prenom }}">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control" type="email" id="email" name="email" placeholder="Email" value="{{ $employe->email }}">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="cal-icon">
                                                                <input class="datepicker-default form-control" type="date" name="date_de_naissance" value="{{ $employe->date_de_naissance }}">
                                                    ...
                                                    <div class="col-sm-6">  
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" class="form-control" id="numero" name="numero" placeholder="Votre numéro" value="{{ $employe->numero }}">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="select form-control" id="poste" name="poste">
                                                                <option value="{{ $employe->poste }}">{{ $employe->poste }}</option>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="cal-icon">
                                                                <input class="datepicker-default form-control" type="date" name="date_de_recrutement" value="{{ $employe->date_de_recrutement }}">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="select form-control" id="status" name="status">
                                                                <option value="{{ $employe->status }}">{{ $employe->status }}</option>
                                                    ...
                                                    <div class="col-sm-6">  
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" class="form-control" id="matricule" name="matricule" placeholder="Votre matricule" value="{{ $employe->matricule }}">
                                                    ...
                                                    <div class="col-sm-6">  
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="adress" name="adress" placeholder="Votre adresse" value="{{ $employe->adress }}">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <label for="avatar" class="col-form-label">Profil<span class="text-danger"> Veuillez verifier votre profil</span></label>
                                                            <input type="file" class="form-control" id="avatar" name="avatar" value="{{ $employe->avatar }}">
                                                            <span class="text-danger">@error('avatar') {{$message}} @enderror</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="submit-section">
                                                    <button class="btn btn-primary submit-btn" onclick="return confirm('Voulez-vous vraiment modifier les données de'+' {{ $employe->nom }}')" type="submit">Modifier Employe</button>
                                                </div>
                                            </form>
                                        </div>

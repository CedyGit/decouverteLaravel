                                                    ...
                                                    @foreach ($user as $details)
                                                        ...
                                                        <div class="card-header">
                                                            <div class="row">
                                                                ...
                                                                <!-- photo -->
                                                                    <div class="profile-img-wrap">
                                                                        <div class="profile-img">
                                                                            <a href="{{ url('editUser/'.$details->id) }}" title="Mofifier?">
                                                                                <img src="{{ url('../upload/' . $details->photo) }}" alt="">
                                                                            </a>
                                                                        </div>
                                                                    </div>
                                                                <!-- fin photo -->
                                                                ...
                                                                <div class="col-md-8">
                                                                    <h3 class="text-center" style="color:ghostwhite ;">Details de {{$details->nom}}</h3>
                                                                    <hr> 
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="card-body">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        ...
                                                                        <div class="p-2 border">{{$details->phone}}</div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        ...
                                                                        <div class="p-2 border">{{$details->usertype}}</div>
                                                                    </div>
